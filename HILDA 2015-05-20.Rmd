...
Moreover, we can replace the age of subject with the years since studying FT (ehtse). Also, we now restrict the analysis to workers with info on years since last studying.

```{r years_since_studying, eval=T, include=T, echo=F, comment=NA, cache=F}
